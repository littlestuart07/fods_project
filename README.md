...
- `DA1_combined_analysis.ipynb`
- `DA2_models.ipynb`

The full project is available on GitHub: [`Sahil689172/FODS-DA`](https://github.com/Sahil689172/FODS-DA).

---

## 1. Project Overview

### DA-1: Data Cleaning, Integration & EDA

Notebook: `DA1_combined_analysis.ipynb`
...
### DA-2: Modeling & Advanced Random Forest Tuning

Notebook: `DA2_models.ipynb`

**Goal:** Predict heart disease (`heart_disease`) using multiple machine learning models and compare performance.

**Input:**
- `combined_cleaned.csv` produced in DA-1.
...
```bash
git clone https://github.com/Sahil689172/FODS-DA.git
cd FODS-DA
```
...
- `heart.csv`
- `smoking.csv`
- `combined_cleaned.csv` (can also be regenerated by running DA-1)

### Step 3: Run DA-1 (optional if you want to regenerate `combined_cleaned.csv`)

1. Open `DA1_combined_analysis.ipynb` in Jupyter / VS Code / Google Colab.
2. Run all cells from top to bottom.
3. Confirm that `combined_cleaned.csv` is (re)created in the project folder.

### Step 4: Run DA-2 (modeling & tuning)

1. Open `DA2_models.ipynb`.
2. Run all cells from top to bottom.
3. Review:
...
If you plan to reuse or extend it, please credit the original author and repository:  
[`https://github.com/Sahil689172/FODS-DA`](https://github.com/Sahil689172/FODS-DA).
